...
async function loadGames (search = '') { //async due to await, search is to search games url is ?search=Mario, if the search is undefined is empty
    ...
    const response = await axios(API_URL + search,{ // default is get if you want post you do axios.post
    headers: {
